...
/// Build a swap instruction for the perps market.
///
/// Accounts: [payer(signer), market(writable), system_program, trader_quote(writable),
///            quote_vault(writable), token_program_quote]
